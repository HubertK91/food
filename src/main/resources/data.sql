...
VALUES('Jan','Kowalski', 'Warszawa', '888999123', 'jan@gmail.com', 'Słoneczna 12', 'jan', '{noop}jan')
     ...
     ,('Hubert', 'Kowalski', 'Warszawa', '888999123', 'hubert@gmail.com', 'Pogodna 22', 'admin', '{noop}admin');

INSERT INTO restaurant(name, username, password, city, phone , email, street_Address)
VALUES ('Sphinx', 'Sphinx', '{noop}sphinx', 'Sosnowiec', '666666666', 'sphinx@gmail.com', 'Czerwonego Krzyża 8'),
       ('Italia', 'Italia', '{noop}italia', 'Sosnowiec', '999666666', 'italia@gmail.com', 'Sobieskiego 10');

INSERT INTO client_order(id_client, restaurant)
VALUES (1,1), (2,1), (1,2);

INSERT INTO client_role(user_id_client, role)
VALUES (3, 'ROLE_ADMIN'), (1, 'ROLE_USER'),(2, 'ROLE_USER');
...
VALUES (1,'Schabowy', 20.0, 0 ,'Polish', 1, 1), (2,'Spaghetti',15.0,0, 'Italian',1, 1),
       (1,'Ryż z kurczakiem', 15.0, 0 ,'Chinese',2, 1), (2,'Musaka', 30.20, 0 ,'Greek',2, 1);
